...
C++ can be used in embedded systems (various devices with tiny computers in them, from fitness trackers to ATMs to cars).
...
Maybe. If you do this, set a goal for yourself to actually create something in C++. Leisurely reading about C++ while not planning to ever do anything with it is a waste of time.
