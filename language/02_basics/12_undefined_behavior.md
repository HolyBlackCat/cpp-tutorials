...
* **Crash** immediately (meaning abruptly close with or without an error message).
...
If you're also following my tooling tutorial, this is a good time to read about [the recommended compiler settings](/tooling/articles/recommended_compiler_flags.md), which explains how to enable it.
