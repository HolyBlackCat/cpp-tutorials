...
The answer to that is: **You don't have to use any Cygwin-based parts of it, other than the package manager.** The toolchain/compilers/libraries you install through it have nothing to do with Cygwin (unless you intentionally install [the ones that do](/tooling/articles/msys2_environments.md#the-msys-environment)), and can be used without it.
